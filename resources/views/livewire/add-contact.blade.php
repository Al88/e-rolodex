        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold dark:text-white">Add a contact</div>
                </div>
                    ...
                    <form class="w-full max-w-lg"  wire:submit.prevent="submit">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                              ...
                              <select class="block appearance-none w-full bg-gray-200 dark:text-white border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="prefix" wire:model="prefix">
                            ...
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                              <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mt-3 dark:text-white" for="title">
                                Title
                              </label>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-6 md:mb-0">
                              <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold dark:text-white" for="email">
                                Email
                              </label>
                            ...
                            <div class="w-full md:w-1/2 px-3">
                              <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 mt-3 dark:text-white" for="defaultPhoneNumber">
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 mt-3 dark:text-white" for="phoneType">
                                  Phone type
                                </label>
                          ...
                          <div class="md:flex md:items-center">
                            <div class="md:w-2/3">
                              <button class="dark:text-white shadow bg-emerald-500 hover:bg-emerald-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                                Add
                              </button>
                            </div>
                          </div>
